...
# Page configuration
st.set_page_config(page_title="Dataset Testing", layout="wide")

st.title("🔬 Ocean Anomaly Detection - Dataset Testing")
...
# Footer
st.markdown("---")
st.markdown("**Ocean Anomaly Detection System** - Upload your data and discover oceanographic events!")
